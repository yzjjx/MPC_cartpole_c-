...
{   // 定义系统初始参数
    ...
    for(int i = 0;i < k_steps;i++)
    {
        ...
        f_current(0) = x_2;
        f_current(1) = -((9.0*sin(x_3)*x_4*x_4)/25000.0 + 
                       (3.0*actual_u)/250.0 - (3.0*x_2)/5000.0 + 
                       (8829.0*cos(x_3)*sin(x_3))/1000000.0)/((9.0*cos(x_3)*cos(x_3))/10000.0 -
                       33.0/2500.0);
        f_current(2) = x_4;
        f_current(3) =-(3.0*((10791.0*sin(x_3))/1000.0 - actual_u*cos(x_3) + (x_2*cos(x_3))/20.0 - 
                      (3.0*x_4*x_4*cos(x_3)*sin(x_3))/100.0))/(100.0*((9.0*cos(x_3)*cos(x_3))/10000.0 - 
                      33.0/2500.0));
